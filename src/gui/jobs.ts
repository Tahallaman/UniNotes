...
export const JOB_DEFINITIONS: readonly JobDefinition[] = [
  ...
  {
    id: "fetch-video",
    label: "Fetch video for selected lectures",
    script: "scripts/fetch-video.ts",
    description: "Download the recordings again so the player has something to play.",
    usesLock: true,
  },
  {
    id: "export",
    ...
    description: "Copy notes into Exports/.",
    usesLock: false,
  },
  {
    id: "sync-workspace",
    label: "Copy to your folder",
    script: "scripts/sync-workspace.ts",
    description: "Copy pretty notes into your study folder, filed by term and week.",
    usesLock: false,
  },
  {
    id: "sync-workspace-dry",
    label: "Preview the copy",
    script: "scripts/sync-workspace.ts",
    args: ["--dry-run"],
    description: "List where every note would land, without writing anything.",
    usesLock: false,
  },
  {
    id: "probe-panopto-view",
    label: "Test Panopto table view",
    script: "scripts/probe-panopto-view.ts",
    description: "Checks the listing page's Date column can be read, and reports what it found.",
    usesLock: false,
  },
  {
    id: "auth-panopto",
